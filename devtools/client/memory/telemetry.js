 ...
 */
exports.countCensus = makeInfallible(function({ inverted, filter,
                                                diffing, breakdown }) {
  ...
  histogram =
      telemetry.getKeyedHistogramById("DEVTOOLS_MEMORY_BREAKDOWN_CENSUS_COUNT");
...
exports.countDominatorTree = makeInfallible(function({ breakdown }) {
  let histogram =
      telemetry.getHistogramById("DEVTOOLS_MEMORY_DOMINATOR_TREE_COUNT");
  histogram.add(1);

  histogram =
      telemetry.getKeyedHistogramById("DEVTOOLS_MEMORY_BREAKDOWN_" +
                                      "DOMINATOR_TREE_COUNT");
